      ...
      <div className="max-w-5xl mx-auto py6">
        <div className="flex flex-col md:flex-row md:items-center justify-between mb-10 md:mb-16 gap-6 md:gap-8">
          <div className="max-w-xl ">
            <h2 className="text-[10px] md:text-sm font-bold tracking-[0.2em] text-slate-400 uppercase mb-2 md:mb-5 flex items-center gap-2">
            ...
            <h3 className="text-3xl md:text-5xl font-black tracking-tight text-sky-900">
              Work &<span className="text-slate-500  font-bold"> Impact</span>
            </h3>
          </div>
        </div>
